            ...
            <div class="row">
                ...
                <div class="col s12 m4">
                    <div class="card-panel teal">
                        <a href="#" id="check" ><span style="font-size: 200%;" class="<?php if ($data['ac_opening_balance'] > 0) {
            echo 'green-cur';
        } else {
            echo 'red-cur';
        } ?>">
                        ...
                        <ul class="collapsible" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header"><i class="material-icons">trending_up</i><?php echo $data['ac_name'] ?>
                                    ...
                                    <span class="<?php if ($data['ac_opening_balance'] > 0) {
                        echo 'green-cur';
                    } else {
                        echo 'red-cur';
                    } ?>">
    ...
    <?php foreach ($array_income as $income_data) {
        ?>
                                                <tr>
                                                    ...
                                                    <td><?php if ($income_data['tr_type'] === '1') {
            echo '+';
        } else {
            echo '-';
        } ?></td>
